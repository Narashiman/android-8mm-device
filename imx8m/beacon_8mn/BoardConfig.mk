...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/beacon_8mn/dtbo-imx8mn.img
...
ifeq ($(TARGET_USE_DYNAMIC_PARTITIONS),true)
  ifeq ($(IMX_NO_PRODUCT_PARTITION),true)
    ...
    TARGET_BOARD_DTS_CONFIG += imx8mn:beacon-imx8mn-hdmi.dtb
    ...
    # imx8mn with MIPI panel display and wifi
    TARGET_BOARD_DTS_CONFIG += imx8mn-mipi-panel:beacon-imx8mn-kit.dtb
    # imx8mn with MIPI-HDMI display and wifi and M7 image
