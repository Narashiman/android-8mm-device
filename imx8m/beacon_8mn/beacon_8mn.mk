...
IMX_DEVICE_PATH := device/fsl/imx8m/beacon_8mn
...
# Overrides
PRODUCT_NAME := beacon_8mn
PRODUCT_DEVICE := beacon_8mn
PRODUCT_MODEL := Beacon EmbeddedWorks i.MX8MN Kit
...
PRODUCT_COPY_FILES += \
    device/fsl/common/audio-json/wm8962_config.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/audio/wm8962_config.json \
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/beacon_8mn/camera_config_imx8mn.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mn.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/beacon_8mn/powerhint_imx8mn.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mn.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/beacon_8mn/thermal_info_config_imx8mn.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mn.json
...
PRODUCT_COPY_FILES += \
    ...
    vendor/nxp/imx-firmware/nxp/FwImage_8997_SD/sdiouart8997_combo_v4.bin:vendor/firmware/sdiouart8997_combo_v4.bin \
