...
# Overrides
PRODUCT_NAME := beacon_8mm
PRODUCT_DEVICE := beacon_8mm
PRODUCT_MODEL := Beacon EmbeddedWorks i.MX8MM Kit
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/beacon_8mm/camera_config_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mm.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/beacon_8mm/powerhint_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mm.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/beacon_8mm/thermal_info_config_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mm.json
